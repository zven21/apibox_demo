defmodule ApiboxDemo.BooksTest do
  ...
  describe "books" do
    ...
    @valid_attrs %{desc: "some desc", price: 42, title: "some title"}
    @update_attrs %{desc: "some updated desc", price: 43, title: "some updated title"}
